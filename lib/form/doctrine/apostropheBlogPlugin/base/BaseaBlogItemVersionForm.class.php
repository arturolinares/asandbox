...
/**
 * aBlogItemVersion form base class.
 *
 * @method aBlogItemVersion getObject() Returns the current form's model object
 *
 * @package    asandbox
 * @subpackage form
 ...
 */
abstract class BaseaBlogItemVersionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('a_blog_item_version[%s]');

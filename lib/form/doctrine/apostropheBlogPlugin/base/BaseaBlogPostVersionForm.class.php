...
/**
 * aBlogPostVersion form base class.
 *
 * @method aBlogPostVersion getObject() Returns the current form's model object
 *
 * @package    asandbox
 * @subpackage form
 ...
 */
abstract class BaseaBlogPostVersionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('a_blog_post_version[%s]');
